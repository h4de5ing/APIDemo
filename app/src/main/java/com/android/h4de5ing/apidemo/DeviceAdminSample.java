...
public class DeviceAdminSample extends PreferenceActivity {
    ...
    public static class AdminSampleFragment extends PreferenceFragment
        ...
        protected void postReloadSummaries() {
            Objects.requireNonNull(getView()).post(this::reloadSummaries);
        }
    ...
    public static class GeneralFragment extends AdminSampleFragment
        ...
        private void postUpdateDpmDisableFeatures() {
            Objects.requireNonNull(Objects.requireNonNull(getView())).post(() -> {
        ...
        private void promptForRealDeviceWipe(final boolean wipeAllData) {
            ...
            builder.setPositiveButton(R.string.wipe_warning_first_ok,
                    (dialog, which) -> {
                        ...
                        if (wipeAllData) {
                            builder1.setMessage(R.string.wipe_warning_second_full);
                        } else {
                            builder1.setMessage(R.string.wipe_warning_second);
                        }
                        builder1.setPositiveButton(R.string.wipe_warning_second_ok,
                                (dialog1, which1) -> {
                        ...
                        builder1.setNegativeButton(R.string.wipe_warning_second_no, null);
                        builder1.show();
                    });
